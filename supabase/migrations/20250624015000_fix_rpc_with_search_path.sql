-- This migration fixes the create_order_from_cart function by explicitly setting the search_path.
-- As per official Supabase documentation, this is a critical security and stability measure
-- for all SECURITY DEFINER functions to prevent privilege escalation and ensure a predictable execution context.

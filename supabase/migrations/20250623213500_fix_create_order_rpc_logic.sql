-- This migration fixes the create_order_from_cart function.
-- It was failing silently because it tried to select a non-existent 'total_amount' column from the 'carts' table.
-- This version correctly calculates the total amount from the 'cart_items' table.
...
BEGIN
    ...
    RAISE NOTICE '[RPC] Calculating total amount from cart_items...';
    SELECT SUM(ci.quantity * ci.price) INTO v_total_amount

...
const invalidTypeMessage = (fieldName: string, type: string) => `${fieldName} doit être de type ${type}.`;
...
export const addressSchema = z.object({
  ...
  country_code: z.string()
    ...
    .regex(/^[A-Z]{2}$/, "Le code pays doit être composé de 2 lettres majuscules (format ISO 3166-1 alpha-2).")

...
import type { AppRole, AppPermission } from "@/config/permissions";
...
describe("hasPermission", () => {
  ...
  test("should return false for a null or undefined role", () => {
    expect(hasPermission(null as unknown as AppRole, "products:read")).toBe(false);
    expect(hasPermission(undefined as unknown as AppRole, "products:read")).toBe(false);
  });

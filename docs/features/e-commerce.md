...
export async function getProductBySlugAction(slug: string, locale: string): Promise<ActionResult<ProductDetail>>
...
export async function updateProductAction(id: string, data: UpdateProductInput): Promise<ActionResult<Product>>
...
const AddressSchema = z.object({
  ...
  phone_number: z.string().regex(/^(?:\+33|0)[1-9](?:[0-9]{8})$/).optional()
});
```
